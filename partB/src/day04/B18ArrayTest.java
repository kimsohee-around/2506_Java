...
public class B18ArrayTest {
  public static void main(String[] args) {
    ...
    // 배열의 기본속성 (메소드 아님)
    System.out.println("arr1 길이: " + arr1.length); // 5
    System.out.println("arr2 길이: " + arr2.length); // 10

    // 배열요소는 인덱스로 지정합니다. 인덱스 0 부터.
    // arr1, arr2 배열 마지막 요소를 99 로 저장하기
    ...
    // 자바 배열 관련 메소드는 Arrays 클래스의 static 메소드 사용합니다.
    ...
    // Arrays 의 메소드 중에서 fill, sort 는 리턴타입이 void 이며. 배열의 요소값들을 변경
  }
}
