...
public class B01ObjectTest {
  ...
  public static void main(String[] args) {
    ...
    momo.eng = 100;
    momo.math = 100;
    System.out.println("momo 의 정보 : " + momo); // 참조값은 변경되지 않습니다.
  }
  // 결론 : 여기까지 Score 객체는 몇개? 1개
